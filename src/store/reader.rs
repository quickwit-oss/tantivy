...
impl StoreReader {
    ...
    /// for instance.
    pub fn get<D: DocumentDeserializeOwned>(&self, doc_id: DocId) -> crate::Result<D> {
    ...
    pub fn iter<'a: 'b, 'b, D: DocumentDeserializeOwned>(
        &'b self,
...
impl StoreReader {
    ...
    pub async fn get_async<D: DocumentDeserializeOwned>(
        &self,
        doc_id: DocId,
        executor: &Executor,
    ) -> crate::Result<D> {
