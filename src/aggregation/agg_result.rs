...
///
/// Note the type information loss compared to `CompositeIntermediateKey`. This
/// is fine when paginating within a single Tantivy index because Str, IpAddr
/// and DateTime type columns cannot coexist at the same path. This doesn't hold
/// if you need to paginate across multiple indexes (e.g Quickwit splits).
