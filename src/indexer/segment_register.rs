...
mod tests {
    use super::*;
    use crate::core::{SegmentAttributes, SegmentId, SegmentMetaInventory};
    ...
    fn test_segment_register() {
        ...
        {
            let segment_meta =
                inventory.new_segment_meta(segment_id_a, 0u32, SegmentAttributes::default());
        ...
        {
            let segment_meta =
                inventory.new_segment_meta(segment_id_b, 0u32, SegmentAttributes::default());
            let segment_entry = SegmentEntry::new(segment_meta, delete_queue.cursor(), None);
            segment_register.add_segment_entry(segment_entry);
        }
        ...
        segment_register.remove_segment(&segment_id_b);
        {
            let segment_meta_merged =
                inventory.new_segment_meta(segment_id_merged, 0u32, SegmentAttributes::default());
